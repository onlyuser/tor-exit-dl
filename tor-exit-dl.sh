...
echo "1. Issue command "tor-exit-dl [COUNTRY_CODE [TOP_N]]" in a bash terminal (Do not include square brackets)."
echo "2. sudo vi /etc/tor/torrc"
echo "3. Append router names to the line that begins with \"exitnodes\" in file \"torrc\""
echo "4. sudo /etc/init.d/tor restart"
